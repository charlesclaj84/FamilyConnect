...
/**
 * `/admin/gatherings/templates` IS A REDIRECT NOW, and the library it used to be is the
 ...
 * notice.
 *
 * The same arrangement `/admin/members/organization` has had since the Organization pane absorbed it — and
