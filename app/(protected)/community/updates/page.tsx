...
/**
 * `/community/updates` IS A REDIRECT NOW, and the screen it used to be is the Updates pane of
 ...
 *     which is exactly the shape `/admin/members/organization` kept its entry for when Regions &
 ...
 * lands on `/community/announcements`, which resolves `requireFamilyActive`, `requireTier` and all
...
export default function UpdatesPage() {
  redirect('/community/announcements?pane=updates')
}
