                  ...
                  {canDecide && (
                    <div className="flex shrink-0 items-center gap-2">
                      <button
                        ...
                        className="inline-flex items-center gap-1 rounded-lg bg-[#0f2540] px-2.5 py-1 text-xs font-medium text-[#e6ecfa] transition-opacity hover:opacity-90 disabled:opacity-60"
                      >
