          ...
          >
            ...
            <div className="flex justify-end gap-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-1 rounded-lg bg-[#0f2540] px-3 py-1.5 text-sm font-medium text-[#e6ecfa] transition-opacity hover:opacity-90 disabled:opacity-60"
              >
