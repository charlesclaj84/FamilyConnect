        ...
        sections: [
          ...
          },
          {
            ...
            blocks: [
              ...
              p('**A brother or sister needs the parent they share, or they do not join the bloodline.** A sibling connection says two people are siblings; it does not say whose children they are, and the walk follows parents. So a sister added as a blood sister of somebody with no parents on the tree gets no droplet and does not appear under **Bloodline** — the tree has not been told what it needs. Record the parent they share on both of them and both appear. The dialog asks you as you add them when it can, and says so when there is nobody yet to offer.'),
              note('This matters beyond the toggle: a due set to **Bloodline only** is owed by the people in that set, so somebody missing from it is not billed for one. If a relative you expect to owe a bloodline due does not, this is the first thing to check.'),
            ],
          },
          {
            id: 'fixing',
