        ...
        sections: [
          ...
          },
          {
            ...
            blocks: [
              ...
              p('Tick it for a blood relative. Leave it clear for somebody who married in, and for a step, adopted or foster relative. The dialog asks as you add a new relative; afterwards, open anybody’s card and tick it there. It saves as soon as you tick it.'),
          ...
          },
          {
            ...
            blocks: [
              bullets(
                'Wrong relationship — open the manage dialog on the connection. A marriage can be renamed there, **Husband** to **Ex-husband**. Whether somebody is in the bloodline is a tick on their own card in the same dialog.',
