        ...
        sections: [
          ...
          },
          {
            ...
            blocks: [
              ...
              p('A former marriage is recorded by adding the spouse and then opening the manage dialog on either of them: under **Marriages** each spouse has three words — **Wife**, **Ex-wife** and **Partner**, or the same three for a husband. Press one and then **Save**. **Partner** is the word for a couple who are not married; there is no blank option, because every connection on the tree has a word. An ex is drawn beside the person exactly where a current spouse is, deliberately — it is often where half the children came from.'),
          ...
          },
          {
            ...
            blocks: [
              bullets(
                'Wrong relationship — a marriage can be renamed in the manage dialog under **Marriages**, **Husband** to **Ex-husband**; anything else is removed and drawn again. Whether somebody is in the bloodline is a tick in the same dialog on their own card.',
